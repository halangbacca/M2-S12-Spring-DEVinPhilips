...
INSERT INTO usuarios(cpf, data_nascimento, email, estado_civil, genero, naturalidade, nome, rg, telefone, crm,
                     especialidade, senha)
VALUES ('548.430.980-86', TO_DATE('05/09/1994', 'DD/MM/YYYY'), 'pamela@outlook.com', 'CASADO', 'Feminino', 'Blumenauense', 'Pâmela Fraga',
        '27.618.316-2', '(11) 62384-2885', '555/SP', 'ORTOPEDIA', 'qwe12345');

INSERT INTO usuarios(cpf, data_nascimento, email, estado_civil, genero, naturalidade, nome, rg, telefone, crm,
                     especialidade, senha)
VALUES ('313.624.040-55', TO_DATE('10/05/1990', 'DD/MM/YYYY'), 'carlos@outlook.com', 'SOLTEIRO', 'Masculino', 'Itajaiense', 'Carlos Alberto',
...
INSERT INTO pacientes (cpf, data_nascimento, email, estado_civil, genero, naturalidade, nome, rg, telefone, alergias,
                       ...
                       endereco_id)
VALUES ('047.648.760-94', TO_DATE('05/12/1963', 'DD/MM/YYYY'), 'guilherme@outlook.com', 'SOLTEIRO', 'Masculino', 'Tubaronense',
...
INSERT INTO pacientes (cpf, data_nascimento, email, estado_civil, genero, naturalidade, nome, rg, telefone, alergias,
                       contato_de_emergencia, convenio, cuidados_especificos, numero_convenio, validade_convenio,
                       endereco_id)
VALUES ('709.761.510-90', TO_DATE('02/04/1981', 'DD/MM/YYYY'), 'daniel@outlook.com', 'SOLTEIRO', 'Masculino', 'Balneocamboriuense',
...
VALUES (TIMESTAMP '2023-04-20 09:11:10', 'Paciente teve contato com animais contaminados', '100mg/dia', 'Itraconazol',
        'Suspeita de esporotricose humana', 1, 1);

INSERT INTO consultas (data_hora, descricao, dosagem, medicacao, motivo, usuario_id, paciente_id)
VALUES (TIMESTAMP '2023-04-21 10:11:10', 'Paciente apresentava-se extremamente ansioso', '10mg/dia', 'Oxalato de Escitalopram',
        'Transtorno de ansiedade', 1, 1);


INSERT INTO consultas (data_hora, descricao, dosagem, medicacao, motivo, usuario_id, paciente_id)
VALUES (TIMESTAMP '2023-04-15 15:11:10', 'Paciente apresentava tosse e desconforto abdominal', '15 mg/kg/dia', 'Albendazol',
        'Síndrome de Loeffler causado por Ascaris lumbricoides', 2, 2);


INSERT INTO consultas (data_hora, descricao, dosagem, medicacao, motivo, usuario_id, paciente_id)
VALUES (TIMESTAMP '2023-03-14 17:11:10', 'Paciente com mialgia, febre e manchas no corpo', 'Não se aplica',
        'Reposição volêmica',
        'Suspeita de dengue', 2, 2);

# EXAMES
INSERT INTO exames (data_hora, laboratorio, nome, pdf, resultados, tipo, usuario_id, paciente_id)
VALUES (TIMESTAMP '2023-04-20 09:11:10', 'UNIMED', 'Urocultura', 'www.google.com', 'Crescimento de Escherichia coli',
        'Microbiologia', 1, 1);

INSERT INTO exames (data_hora, laboratorio, nome, pdf, resultados, tipo, usuario_id, paciente_id)
VALUES (TIMESTAMP '2023-04-21 14:11:10', 'São Lucas', 'Hemograma', 'www.facebook.com', 'Microcitose++',
        'Hematologia', 1, 1);

INSERT INTO exames (data_hora, laboratorio, nome, pdf, resultados, tipo, usuario_id, paciente_id)
VALUES (TIMESTAMP '2023-04-19 17:15:00', 'SUS', 'RT-qPCR', 'www.instagram.com', 'Presença de material genético de SARS-CoV-2',
        'Biologia Molecular', 2, 2);

INSERT INTO exames (data_hora, laboratorio, nome, pdf, resultados, tipo, usuario_id, paciente_id)
VALUES (TIMESTAMP '2023-03-18 13:30:45', 'SUS', 'Parasitológico de fezes', 'www.twitter.com',
